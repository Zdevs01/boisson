...
<?php
  ...
  if (isset($_POST['edit'])) {
    if (isset($_POST['edit'])) {
      ...
      header("Location: productlist.php"); // Redirection vers la liste des clients
      exit();
...
<head>
  ...
  <meta name="description" content="Entrepôt de Boissons - Mise à jour des produits" />
  <meta name="keywords" content="produits, gestion, stock, boissons, entrepôt, vente" />
      ...
      <div class="content">
        <div class="page-header">
          <div class="page-title">
            <h4>Modifier le Produit 🛠️</h4>
            <h6>Mettre à jour votre produit 🍹</h6>
          </div>
        </div>
        <div class="card">
          <div class="card-body">
            <form class="row" method="post" action="editproduct.php" enctype="multipart/form-data">
              <div class="col-lg-3 col-sm-6 col-12">
                <div class="form-group">
                  <label>Référence du produit 🏷️</label>
                ...
                <div class="form-group">
                  ...
                  <div class="image-upload">
                    ...
                    <div class="image-uploads">
                      ...
                      <h4>Faites glisser et déposez un fichier pour télécharger</h4>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-lg-12">
                <button class="btn btn-submit me-2" name="edit">Mettre à jour 🔄</button>
