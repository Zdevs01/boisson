...
<head>
    ...
    <title>Facture - <?php echo $sales_code ?></title>
    <style>
        /* Styles généraux */
        body {
...
<body>
    <div class="card card-outline card-primary">
        ...
        <div class="card-header">
            <h4>Registre des ventesFF - <?php echo $sales_code ?></h4>
        </div>
        ...
        <div class="card-header">
            <h4>Registre des ventes - <?php echo $sales_code ?></h4>
        </div>
        <div class="card-body" id="print_out">
            <div class="container-fluid">
                <div class="logo-header">
        ...
        <div class="card-footer text-center">
            ...
            <a class="btn btn-primary" href="<?php echo base_url.'/admin?page=sales/manage_sale&id='.(isset($id) ? $id : '') ?>">Modifier</a>
            <a class="btn btn-dark" href="<?php echo base_url.'/admin?page=sales' ?>">Retour à la liste</a>
        </div>
    </div>
