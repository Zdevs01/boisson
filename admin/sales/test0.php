...
<head>
    ...
    <title>Facture de Vente - <?php echo $sales_code ?></title>
    <style>
        body {
...
<div class="card card-outline card-primary">
    ...
    <div class="card-footer">
        ...
        <a class="btn btn-primary" href="edit_invoice.php?id=<?php echo $sales_code ?>">Modifier</a>
        <a class="btn btn-danger" href="delete_invoice.php?id=<?php echo $sales_code ?>">Supprimer</a>
        <a class="btn btn-dark" href="sales_list.php">Retour</a>
    </div>
</div>
