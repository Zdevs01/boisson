...
<div class="card card-outline card-primary shadow-lg border-0">
    ...
    <div class="card-footer py-3 text-center bg-secondary">
        ...
        <a class="btn btn-primary btn-lg shadow-sm" href="<?php echo base_url.'/admin?page=sales/manage_sale&id='.(isset($id) ? $id : '') ?>">✏️ Modifier</a>
        <a class="btn btn-dark btn-lg shadow-sm" href="<?php echo base_url.'/admin?page=sales' ?>">🔙 Retour</a>
    </div>
</div>
