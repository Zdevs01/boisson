    ...
    <div class="row justify-content-center align-items-end">
        ...
        <div class="col-md-3">
            <div class="form-group position-relative">
                ...
                <input type="date" class="form-control rounded-0 border border-primary shadow-sm" 
...
<script>
    ...
    document.getElementById('add_to_list').addEventListener('click', function() {
        ...
        let containingInput = document.getElementById('containing');
        ...
        let containingValue = containingInput.value;
        let totalPrice = (qtyValue * priceValue).toFixed(2);

        if (!itemText || !unitText || !qtyValue || !priceValue) {
        ...
        let newRow = `
            <tr>
                ...
                <td class="py-1 px-2 text-center">${containingValue}</td>
                <td class="py-1 px-2 text-center">${qtyValue}</td>
                <td class="py-1 px-2 text-center">${unitText}</td>
                <td class="py-1 px-2">${itemText}</td>
                <td class="py-1 px-2 text-right">${priceValue}</td>
                <td class="py-1 px-2 text-right">${totalPrice}</td>
            </tr>
        `;
...
<script>
    ...
    function updateQuantityLabel() {
        var unit = $('#unit').val();
        if (unit === 'carton') {
            $('#qty_label').text('Quantité (Nombre de bouteilles)');
        } else if (unit === 'pack') {
            $('#qty_label').text('Quantité (Nombre de packs)');
        }
    }
    ...
    $('#add_to_list').click(function(){
        ...
        if (unit === 'carton') {
            qty = qty * 12; // Supposons que chaque carton contient 12 bouteilles
        }
